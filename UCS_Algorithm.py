    ...
    def search(self, start_map=None):
        ...
        while not heap.is_empty():
            ...
            if goal_car.position[0] + goal_car.vtype == 6:
                ...
                tracemalloc.stop()
                print(f"[UCS] Time: {self.execution_time:.4f}s | Nodes expanded: {self.nodes_expanded} | Max frontier size: {self.max_frontier_size} | Memory usage: {self.memory_usage_kb} KB")
                return current_map
        ...
        self.memory_usage_kb = peak // 1024
        tracemalloc.stop()
        print(f"[UCS] No solution. Time: {self.execution_time:.4f}s | Nodes expanded: {self.nodes_expanded} | Max frontier size: {self.max_frontier_size} | Memory usage: {self.memory_usage_kb} KB")
        return None
